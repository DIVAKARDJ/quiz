...
;(function ($, window, document, undefined) {
    ...
    Owl.Workers = [
        {
            ...
            run: function () {
                ...
                while (repeat--) {
                    ...
                    clones.push(this.normalize(
                        items.length - 1 - (clones.length - 1) / 2, true));
    ...
    Owl.prototype.onDragStart = function (event) {
        ...
        $(document).
            one('mousemove.owl.core touchmove.owl.core',
    ...
    Owl.prototype.closest = function (coordinate, direction) {
        ...
        if (!this.settings.freeDrag) {
            ...
            $.each(coordinates, $.proxy(function (index, value) {
                ...
                if (direction === 'left' && coordinate > value - pull &&
                    coordinate < value + pull) {
                    position = index;
                    // on a right pull, check on previous index
                    // to do so, subtract width from value and set position = index + 1
                } else if (direction === 'right' && coordinate > value - width -
                    pull && coordinate < value - width + pull) {
                    position = index + 1;
    ...
    Owl.prototype.clones = function (position) {
        ...
        return $.map(this._clones,
            function (v, i) { return v === position ? map(i) : null; });
    };
    ...
    Owl.prototype.register = function (object) {
        if (object.type === Owl.Type.Event) {
            ...
            this._states.tags[object.name] = $.grep(
                this._states.tags[object.name], $.proxy(function (tag, i) {
                ...
                function (e) {
                    ...
                    if ((e.property && e.property.name == 'position') ||
                        ...
                        while (i++ < n) {
                            ...
                            clones && $.each(this._core.clones(
                                this._core.relative(position)), load);
                            position++;
                        }
                    }
                }, this),
    ...
    Video.prototype.play = function (event) {
        ...
        if (video.type === 'youtube') {
            html = '<iframe width="' + width + '" height="' + height +
                ...
                video.id + '?autoplay=1&rel=0&v=' + video.id +
...
;(function ($, window, document, undefined) {
    ...
    Navigation.prototype.draw = function () {
        ...
        this._controls.$relative.toggleClass('disabled',
