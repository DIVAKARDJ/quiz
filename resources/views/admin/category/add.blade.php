                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__('White Version Image')}}<span class="text-danger"></span></label>
                                        <div id="file-upload" class="section">
                                            <!--Default version-->
                                            <div class="row section">
                                                <div class="col s12 m12 l12">
                                                    <input name="white_image" type="file" id="input-file-now" class="dropify" data-default-file="{{isset($category) && !empty($category->white_image) ? asset(path_category_image().$category->white_image) : ''}}" />
                                                    @if ($errors->has('white_image'))
                                                        <div class="text-danger">{{ $errors->first('white_image') }}</div>
                                                    @endif
                                                </div>
                                            </div>
                                            <!--Default value-->
