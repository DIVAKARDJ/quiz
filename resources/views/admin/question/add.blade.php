                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="video_link" @if(isset($question)) value="{{ $question->video_link }}" @else value="{{ old('video_link') }}" @endif class="form-control" placeholder="Embed video url">
