...
@push('page-css')
    <link rel="stylesheet" type="text/css" href="{{ asset('web_assets/styles/about.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('web_assets/styles/about_responsive.css') }}">
@endpush
@section('main-body')

    @include('web.include.breadcrumbs',['currentName' => 'About'])
            ...
            <div class="row about_row">
                ...
                <div class="col-lg-4 about_col about_col_left">
                    <div class="about_item">
                        <div class="about_item_image"><img src="{{ asset('web_assets/images/about_1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 about_col about_col_middle">
                    <div class="about_item">
                        <div class="about_item_image"><img src="{{ asset('web_assets/images/about_2.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 about_col about_col_right">
                    <div class="about_item">
                        <div class="about_item_image"><img src="{{ asset('web_assets/images/about_3.jpg') }}" alt="">
                        </div>
    ...
    <div class="feature">
        <div class="feature_background"
             style="background-image:url({{ asset('web_assets/images/courses_background.jpg') }})"></div>
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-center">
                ...
                <div class="col-lg-6 feature_col">
                    <div class="feature_video d-flex flex-column align-items-center justify-content-center">
                        <div class="feature_video_background"
                             style="background-image:url({{ asset('web_assets/images/video.jpg') }})"></div>
        ...
        <div class="container">
            ...
            <div class="row team_row">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="{{ asset('web_assets/images/team_1.jpg') }}" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="{{ asset('web_assets/images/team_2.jpg') }}" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="{{ asset('web_assets/images/team_3.jpg') }}" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col-lg-3 col-md-6 team_col">
                    <div class="team_item">
                        <div class="team_image"><img src="{{ asset('web_assets/images/team_4.jpg') }}" alt=""></div>
                        <div class="team_body">
                ...
                <div class="col">
                    <div class="partners_slider_container">
                        <div class="owl-carousel owl-theme partners_slider">
                            ...
                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_1.png') }}"
                                                                    alt=""></div>

                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_2.png') }}"
                                                                    alt=""></div>

                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_3.png') }}"
                                                                    alt=""></div>

                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_4.png') }}"
                                                                    alt=""></div>

                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_5.png') }}"
                                                                    alt=""></div>

                            <!-- Partner Item -->
                            <div class="owl-item partner_item"><img src="{{ asset('web_assets/images/partner_6.png') }}"
                                                                    alt=""></div>
