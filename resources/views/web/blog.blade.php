...
@push('page-css')
    <link rel="stylesheet" type="text/css" href="{{ asset('web_assets/styles/blog.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('web_assets/styles/blog_responsive.css') }}">
@endpush
@section('main-body')

    @include('web.include.breadcrumbs',['currentName' => 'Blog'])
    <!-- Blog -->
                    ...
                    <div class="blog_post_container">
                        ...
                        <div class="blog_post trans_200">
                            ...
                            <div class="blog_post_body">
                                <div class="blog_post_title"><a href="blog_single.html">Here’s What You Need to Know
                                        About Online Testing</a></div>
                        ...
                        <div class="blog_post trans_200">
                            <div class="blog_post_body">
                                <div class="blog_post_title"><a href="blog_single.html">With Changing Students and
                                        Times</a></div>
                                <div class="blog_post_meta">
                                    <ul>
                                        <li><a href="#">admin</a></li>
                        ...
                        <div class="blog_post trans_200">
                            ...
                            <div class="blog_post_body">
                                <div class="blog_post_title"><a href="blog_single.html">Building Skills Outside the
                        ...
                        <div class="blog_post trans_200">
                            ...
                            <div class="blog_post_body">
                                <div class="blog_post_title"><a href="blog_single.html">Law Schools Debate a Contentious
                                        Testing Alternative</a></div>
                                <div class="blog_post_meta">
                                    <ul>
                                        <li><a href="#">admin</a></li>
                                        <li><a href="#">november 11, 2017</a></li>
