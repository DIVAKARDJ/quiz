        ...
        <div class="container">
            ...
            <div class="row courses_row">
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="{{ asset('web_assets/images/course_1.jpg') }}" alt=""></div>
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="{{ asset('web_assets/images/course_2.jpg') }}" alt=""></div>
                        <div class="course_body">
                ...
                <div class="col-lg-4 course_col">
                    <div class="course">
                        <div class="course_image"><img src="{{ asset('web_assets/images/course_3.jpg') }}" alt=""></div>
                        <div class="course_body">
            ...
            <div class="row events_row">
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_left">
                        <div class="event_image"><img src="{{ asset('web_assets/images/event_1.jpg') }}" alt=""></div>
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_mid">
                        <div class="event_image"><img src="{{ asset('web_assets/images/event_2.jpg') }}" alt=""></div>
                        <div class="event_body d-flex flex-row align-items-start justify-content-start">
                            <div class="event_date">
                                <div class="d-flex flex-column align-items-center justify-content-center trans_200">
                ...
                <div class="col-lg-4 event_col">
                    <div class="event event_right">
                        <div class="event_image"><img src="{{ asset('web_assets/images/event_3.jpg') }}" alt=""></div>
                        <div class="event_body d-flex flex-row align-items-start justify-content-start">
                            <div class="event_date">
                                <div class="d-flex flex-column align-items-center justify-content-center trans_200">
