...
//    Route::get('question/{id}', 'QuestionController@singleQuestion');
    ...
    Route::post('withdrawal-process', 'WithdrawalController@withdrawalProcess');
    Route::get('withdrawal-history', 'WithdrawalController@withdrawalHistory');
    Route::get('referral-list', 'UserController@referralList');
    Route::get('referral-bonus-list', 'UserController@referralBonusList');
    Route::get('reward-list', 'UserController@rewardList');
    
    Route::get('reward-point-list', 'UserController@rewardPointList');
    Route::get('referral-link', 'UserController@referralLink');
    Route::get('coin-price', 'CoinController@coinPrice');
    Route::get('point-price', 'CoinController@pointPrice');
    
    Route::post('buy-coin-by-razor-pay', 'CoinController@buyCoinByRazorPay');
